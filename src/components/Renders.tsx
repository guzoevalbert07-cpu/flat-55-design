    ...
    <section className="section" id="photos" aria-labelledby="renders-h">
      <div className="wrap">
        ...
        <p className="lead">
          ...
          Вход, коридор и санузлы строятся на кадрах из видео: уложенная плитка и подиум душа сохраняются, добавляется только чистовая комплектация.
        ...
        <div className="renders">
          {list.map((r) => (
            <figure className="render" key={r.view}>
              ...
              <figcaption>
                <b>{r.title}</b>
                {r.kind === 'kontext' && <span className="pill" style={{ marginLeft: 6 }}>на основе видео</span>}
              </figcaption>
            </figure>
          ))}
        </div>
