    ...
    <footer>
      <div className="wrap">
        ...
        <p className="muted small">
          План и развёртки — схематичные, масштаб условный, размеры по плану БТИ и правкам брата. Визуализации комнат сгенерированы нейросетью (FLUX) по
          планировочному решению, материалам опции и кадрам видео; это иллюстрации замысла, реальные модели и оттенки — по смете и ссылкам. Рабочие чертежи
          делаются после выбора опции.
        </p>
      </div>
    </footer>
  );
